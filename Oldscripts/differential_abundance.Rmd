...
#Taxa - DEICODE output
ftbl_rclr_species <- read.csv("mock_data/decoide_output/Mocks_Taxa_Filtered_rclr.csv", row.names=1)
...
ftbl_rclr_pwys <- 
  read.csv("mock_data/decoide_output/Mocks_Pathways_Filtered_rclr.csv", row.names=1)
...
ftbl_rclr_card <- 
  read.csv("mock_data/decoide_output/Mocks_CARD_Filtered_rclr.csv", row.names=1)
rownames(ftbl_rclr_card) <- colnames(CDcard_All)
colnames(ftbl_rclr_card) <- rownames(CDcard_All)

#Virulence Factors - DEICODE output
ftbl_rclr_vfdb <- 
  read.csv("mock_data/decoide_output/Mocks_VF_Filtered_rclr.csv", row.names=1)
