...
#Load data
#Taxa
mock_taxa=read.csv("mock data/decoide_output/Mocks_Taxa_Filtered_rclr.csv", row.names=1)
#Pathways
mock_path=read.csv("mock data/decoide_output/Mocks_Pathways_Filtered_rclr.csv", row.names=1)
